...
import { getOrder, getOrderEvents, getOrderRefunds } from "@everfit/core/lib/orders";
import { getAdminUser } from "@/lib/admin-auth";
import { courierName, trackingUrl } from "@everfit/core/lib/couriers";
import AutoRefresh from "@/components/AutoRefresh";
import StatusBadge from "@/components/StatusBadge";
import { InvoiceIcon, PrinterIcon } from "@/components/icons";
...
export default async function OrderDetail({
  ...
  return (
    <div className="space-y-6">
      <AutoRefresh />
      <div>
        <Link href="/orders" className="text-sm text-[#6b7194] hover:text-[#2b337d]">
          ← All orders
        </Link>
